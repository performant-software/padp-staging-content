...
sections:
  - title: Privacy Policy
    subtitle: How the Pan-African Data Project handles data from visitors to the site
    background_image: >-
  ...
  - body: >
      **Last updated: October 15, 2025**
      ...
      with the African American Digital and Experimental Humanities Initiative
      (AADHum) at the University of Maryland, College Park; Performant Software
      Solutions; and student researchers.
      ...
      * IP address (used for security and analytics only).
      ...
      organizations, and events related to Pan-Africanism since the late
      nineteenth century. 
      ...
      * When you export data, the resulting JSON file is created on your device
      ...
      This site uses only the technologies necessary for it to function
      properly, including:


      * Essential cookies that keep the website secure and stable;

      * Local storage in your browser to remember accessibility preferences and
      saved searches; and

      * Session cookies that enable secure login for authorized contributors.


      No information from these cookies or local-storage items is transmitted to
      our servers for tracking, advertising, or marketing purposes.


      By continuing to use this site, you consent to the use of these essential
      features.
      ...
      * Manage authentication and access for approved contributors;

      * Monitor aggregate, anonymized site usage; and

      * Respond to visitor inquiries.


      We do not use visitor data for profiling, marketing, or commercial
      purposes, and we do not sell or share your data with third parties.
